<!-- src/views/products/clamps/WeldingMulti.vue -->
<template>
    <section class="product-detail-section">
        <div class="inner-container">
            ...
            <div class="product-header">
                <h2 class="product-title">용접 클램프, 멀티 타입</h2>
                <p class="product-code">WMC2 / 4</p>
            </div>

            <!-- 오버뷰: 이미지 & 특징 -->
            <div class="product-overview">
                <div class="image-block">
                    <img :src="mainImage" alt="용접 클램프 멀티" class="product-main-image" />
                ...
                <div class="features">
                    <h5>특징</h5>
                    <ul>
                        <li>파이프 고정 및 중심 잡기에 편리합니다.</li>
                        <li>어댑터 교체로 다양한 클램핑 작업이 가능합니다.</li>
                        <li>빠른 조임 핸들이 장착되어 있습니다.</li>
                        <li>육각 헤드 마지막 회전으로 안전한 조임이 보장됩니다.</li>
                    </ul>
            ...
            <div class="bottom-images">
                <div class="bottom-image text-center">
                    ...
                    <p class="text-muted mt-2">사용 예시</p>
                </div>
            </div>
            ...
            <table class="spec-table">
                <tbody>
                    <tr>
                        <th>마감</th>
                        <td>스패터 방지를 위한 나사 부분 동도금</td>
                    </tr>
                    <tr>
                        <th>클램프 범위</th>
                        <td>
                            V형 어댑터: φ13.8〜φ60.5, φ42.7〜φ114.3<br />
                            라운드형 어댑터: 0〜61, 0〜115
                        </td>
                    </tr>
                    <tr>
...
<script>
import mainImage from '@/assets/images/products/clamps/welding-multi.png'
import usageImage from '@/assets/images/products/clamps/welding-multi-bottom.png'
