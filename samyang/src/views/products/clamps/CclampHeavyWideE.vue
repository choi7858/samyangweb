        ...
        <div class="inner-container">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-wrapper breadcrumbs-professional">
                <ol>
                    ...
                    <li aria-current="page">C CLAMPS Heavy Duty Wide Type E</li>
                </ol>
            </nav>

            <!-- 제품 헤더 -->
            <div class="product-header">
                <h2 class="product-title">C CLAMPS Heavy Duty Wide Type E</h2>
            ...
            <div class="product-overview">
                <div class="image-block">
                    <img :src="mainImage" alt="C CLAMPS Heavy Duty Wide Type E" class="product-main-image" />
                ...
                <div class="features">
                    ...
                    <ul>
                        ...
                        <li>Quick tightening handle equipped.</li>
