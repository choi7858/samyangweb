        ...
        <div class="inner-container">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-wrapper breadcrumbs-professional">
                <ol>
                    ...
                    <li aria-current="page">C CLAMP Heavy Duty Wide Type</li>
                </ol>
            </nav>

            <!-- 제품 헤더 -->
            <div class="product-header">
                <h2 class="product-title">C CLAMP Heavy Duty Wide Type</h2>
            ...
            <div class="product-overview">
                <div class="image-block">
                    <img :src="mainImage" alt="C CLAMP Heavy Duty Wide" class="product-main-image" />
                ...
                <div class="features">
                    <h5>Features</h5>
                    <ul>
                        <li>Convenient for operation such as welding and temporary tightening.</li>
                        <li>Deep tightening can be done due to deep throat.</li>
                        <li>Equipped with quick tightening handle.</li>
                        <li>The final turn at a hexagonal head with a wrench ensures the secure tightening.</li>
                        <li>Hole on the body is convenient for fixing plate by bolt and positioning.</li>
                    </ul>
            ...
            <table class="spec-table">
                <tbody>
                    ...
                    <tr>
                        <th>Finish</th>
                        <td>Cathodic Electrodeposition Coating</td>
                    </tr>
                    <tr>
                        <th>Clamp Range</th>
                        <td>50〜200mm</td>
